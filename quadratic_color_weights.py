...
def quadratic_rgb_with_mod(iter_normal, color_mut):
    r = (color_mut[0] * (1 - iter_normal) * iter_normal * 255) % 256
    g = (color_mut[1] * (1 - iter_normal) * iter_normal * 255) % 256
...
higher_order_r, higher_order_g, higher_order_b = quadratic_rgb_with_mod(iter_normals, color_mut)
